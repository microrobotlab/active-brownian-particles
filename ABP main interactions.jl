...
function step(abpe::ABPE, δt::Float64) where {ABPE <: ABPsEnsemble}
    ...
    offcenter = .5
    force, torque = interaction_torque(position(abpe), orientation(abpe), abpe.R, false, offcenter, abpe.L, intrange, shifted_lennard_jones, 5abpe.R, 0.5,-2abpe.R*offcenter)
