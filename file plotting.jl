...
path = raw"C:\Users\j.sharma\OneDrive - Scuola Superiore Sant'Anna\P07Coding\workstationMRL\2025\04.April\V10.0_peakfreq\\"

filename= "v10_perimeter_1000_20000.png"

f= joinpath(path, filename)
f1= joinpath(path, "boxplot_"*filename)
fv= path*"peak_frequencies_v10.0.csv"
...
#  y= df[:,:FFTcurvature]
# x= df[:,:Run]
 p1=histogram(x,xlabel="Frequency(mHz)",ylabel="Count",title="V10",ylims= (0,40), xtickfont=font(12), ytickfont=font(12),color= :lightblue, legend= false)
