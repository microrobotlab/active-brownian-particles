...
mainname = @sprintf "R=%.1f v=%.1f a=%.1f b=%.1f pf=%.1f dt=%.0e Nt=%.0e" R v a b packing_fraction Delta_t Nt
...
println("$mainname; total time simulated $(Delta_t*Nt)")
