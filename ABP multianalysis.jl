...
mainfolder_name = basename(mainfolder)          # e.g., 20250415-561314
        ...
        sub_subfolder = joinpath(mainfolder, "R=1.5 v=5.0 a=50.0 b=12.5 pf=0.2")
        ...
        for i in 1:ICS
            ...
            mainfolder_name = basename(mainfolder)  # e.g., 20250415-561314
            filename = "$mainfolder_name R=$R v=5.0 a=$a b=$b pf=0.2 run$i"
            ...
            # FFT analysis
            peak_freq_mHz, peak_period, freqs_mHz, psd = FFT_analysis_window(t, run_folder, δt, resample, 1)
