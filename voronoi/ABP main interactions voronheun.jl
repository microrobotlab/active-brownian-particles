...
function update_heun(abpe::ABPE, matrices::Tuple{Matrix{Float64}, BitMatrix, BitMatrix}, δt::Float64, offcenter::Float64, int_func::Function, int_params...) where {ABPE <: ABPsEnsemble}
