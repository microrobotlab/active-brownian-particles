...
# PURPOSE: Calculate the packing fraction of particles at the equators or poles when the parameter is same
# METHOD: distance from the center of the ellipse and the tolerence w.r.t perimeter, for instance, R distance from the perimeter
# INPUT: data from a file generated by ABP file.jl 
# OUTPUT: Plot and file of number of particles at equators and poles
...
function stat_analysis(a,b,R,pathf,δt,symmetry)
...
function curvature_analysis(a,b,R,time,gdf,pathf,δt)
  ...
  f5= pathf*"perimeter_p.csv"
  f6= pathf*"perimeter_N.png"
  f7= pathf*"perimenter_Ndiff_eqs.png"
  f8= pathf*"perimeter_curvature_phenomenon.png"
